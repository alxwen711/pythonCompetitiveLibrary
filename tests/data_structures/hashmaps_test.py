...
from src.data_structures.hashmaps import *
from random import randint

def test_base(): #100 random arrays, 20 values each from 1 to 10
    for i in range(100):
        ar = list()
        for j in range(20):
...
def test_speed(): #array with 448 1's, 448 2's... 448 448's
